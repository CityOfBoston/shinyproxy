...
variable "public_application_file" {
  ...
  default = "../../../config/production/public_application.yml"
}
...
module "shiny_proxy" {
  ...
  certficate_arn = "arn:aws:acm:us-east-1:811289587868:certificate/364be4c7-7972-4820-97f7-a820c57389fb"
  use_secure_load_balancer = true
}
